...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-primary': 'linear-gradient(135deg, #0055A4 0%, #004483 100%)',
        'gradient-secondary': 'linear-gradient(135deg, #D32F2F 0%, #a92626 100%)',
        'gradient-hero': 'linear-gradient(to right bottom, #ffffff, #f0f7ff, #e1effe)',
